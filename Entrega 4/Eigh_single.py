...
f = open("Caso_1_eigh_single.txt", "w")
e = 0
...
f = open("Caso_2.1_eigh_single.txt", "w")
e = 0
f.write("Tiempo eigh[s]    Tamaño \n")
while e < len(tamano):
    f.write(f"{tiempo_vvp[e]}   {tamano[e]} \n")
...
f = open("Caso_2.2_eigh_single.txt", "w")
e = 0
f.write("Tiempo eigh[s]    Tamaño \n")
while e < len(tamano):
    f.write(f"{tiempo_vvp[e]}   {tamano[e]} \n")
...
f = open("Caso_3.1_eigh_single.txt", "w")
e = 0
f.write("Tiempo eigh[s]    Tamaño \n")
while e < len(tamano):
    f.write(f"{tiempo_vvp[e]}   {tamano[e]} \n")
...
f = open("Caso_3.2_eigh_single.txt", "w")
e = 0
f.write("Tiempo eigh[s]    Tamaño \n")
while e < len(tamano):
    f.write(f"{tiempo_vvp[e]}   {tamano[e]} \n")
...
f = open("Caso_4.1_eigh_single.txt", "w")
e = 0
f.write("Tiempo eigh[s]    Tamaño \n")
while e < len(tamano):
    f.write(f"{tiempo_vvp[e]}   {tamano[e]} \n")
...
f = open("Caso_4.2_eigh_single.txt", "w")
e = 0
f.write("Tiempo eigh[s]    Tamaño \n")
while e < len(tamano):
    f.write(f"{tiempo_vvp[e]}   {tamano[e]} \n")
...
f = open("Caso_5.1_eigh_single.txt", "w")
e = 0
f.write("Tiempo eigh[s]    Tamaño \n")
while e < len(tamano):
    f.write(f"{tiempo_vvp[e]}   {tamano[e]} \n")
...
f = open("Caso_5.2_eigh_single.txt", "w")
e = 0
f.write("Tiempo eigh[s]    Tamaño \n")
while e < len(tamano):
    f.write(f"{tiempo_vvp[e]}   {tamano[e]} \n")
