...
f = open("Caso_1_solve_single.txt", "w")
e = 0
...
f = open("Caso_2_solve_single.txt", "w")
e = 0
f.write("Tiempo solve[s]    Tamaño \n")
while e < len(tamano):
    f.write(f"{tiempo_solve[e]}   {tamano[e]} \n")
...
f = open("Caso_3_solve_single.txt", "w")
e = 0
f.write("Tiempo solve[s]    Tamaño \n")
while e < len(tamano):
    f.write(f"{tiempo_solve[e]}   {tamano[e]} \n")
...
f = open("Caso_4_solve_single.txt", "w")
e = 0
f.write("Tiempo solve[s]    Tamaño \n")
while e < len(tamano):
    f.write(f"{tiempo_solve[e]}   {tamano[e]} \n")
...
f = open("Caso_5_solve_single.txt", "w")
e = 0
f.write("Tiempo solve[s]    Tamaño \n")
while e < len(tamano):
    f.write(f"{tiempo_solve[e]}   {tamano[e]} \n")
...
f = open("Caso_6_solve_single.txt", "w")
e = 0
f.write("Tiempo solve[s]    Tamaño \n")
while e < len(tamano):
    f.write(f"{tiempo_solve[e]}   {tamano[e]} \n")
...
f = open("Caso_7_solve_single.txt", "w")
e = 0
f.write("Tiempo solve[s]    Tamaño \n")
while e < len(tamano):
    f.write(f"{tiempo_solve[e]}   {tamano[e]} \n")
