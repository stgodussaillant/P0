...
if archivo == "llena":
    f = open("Caso_llena_double.txt", "r")
...
if archivo == "dispersa":
    f = open("Caso_dispersa_double.txt", "r")
...
if archivo == "dispersa":
    plt.title(f"Rendimiento Laplaciana {archivo}")
    plt.yticks(tiempo12, y12)
    plt.ylim(bottom=tiempo12[0], top=tiempo12[-1])
if archivo == "llena":
...
plt.savefig(f"Laplaciana {archivo}")
plt.show()
